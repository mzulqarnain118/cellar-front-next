 ...
 */
export const UnitedStatesFlag = ({ width = 21, height = 15 }: Props) => (
  <svg
    fill="none"
    height={height}
    viewBox="0 0 21 15"
  ...
  >
    <mask height={height} id="mask0_960_4202" maskUnits="userSpaceOnUse" width={width} x="0" y="0">
      <path
