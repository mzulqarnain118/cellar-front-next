                  ...
                  <div className="space-x-4">
                    {!subscription?.SKU?.toLowerCase().startsWith('promo') && (
                      ...
                      >
                        ...
                        <Typography className="group-hover:underline">
                          Skip next shipment
                        </Typography>
                      </Button>
                    )}
                ...
                <div className="grid gap-1">
                  ...
                  {autoSip ? undefined : (
                    <Typography>
                      ...
                      joining one of our Wine Clubs and that you will be billed immediately and
                      every subsequent month, every other month, or every quarter, depending on the
                      frequency of the specific club you selected, until you cancel your membership.
                      The exact amount of the charges will depend upon the specific club you
                      selected. You will be billed on or around the same day each month. You can
                      cancel your membership at any time by logging into your account and cancelling
                      your membership. If you cannot or do not wish to access your account online,
                      ...
                      <Link href="mailto:support@scoutandcellar.com">
                        support@scoutandcellar.com
                      </Link>
                      . Your membership will begin immediately. All charges will be identified as
                      Scout & Cellar or Wine Retriever LLC on your credit card statement. If your
                      card issuing financial institution participates in the Card Account Updater
                      program, we may receive an updated card account number and/or expiration date
                      for your card on file. Unless you opt out of the program with your card
                      issuer, we will update our files and use the new information for any automatic
                      payment option in which you have enrolled, including Scout Circle and Auto-Sip
                      as applicable. We will not receive updated information if your account has
                      been closed.
                    </Typography>
                  )}
                  <Checkbox
