...
export const CartDrawer = () => {
  ...
  //     }
  //   },
  //   [addToCart, cart?.items, updateQuantity]
  // )
    ...
    () =>
      cart?.items.length
        ? cart.items.map((product, index) => {
            const containerSize = product.attributes.find(
              att => att.name === 'Container Size'
            )?.value
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-auto space-y-2 self-center text-center">
                    {/* <NumberPicker
                      ...
                      handleChange={(newQuantity: number) =>
