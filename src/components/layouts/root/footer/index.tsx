    ...
    <div className="container mx-auto space-y-10">
      ...
      >
        ...
        <div className="flex w-full flex-col space-y-4">
          <span className="font-bold text-neutral-500">Shop</span>
        ...
        <div className="flex w-full flex-col space-y-4">
          <span className="font-bold text-neutral-500">Legal</span>
          <div className="space-y-2">
            <div>
              <Link className="hover:underline" href="/">
                Income Disclosure
        ...
        <div className="mb-3 flex space-x-4">
          <Link aria-label="Facebook" href="/">
            <svg height="24" viewBox="0 0 310 310" width="24">
              <path
                className="fill-primary-400 transition hover:fill-primary-500"
          ...
          <Link aria-label="Instagram" href="/">
            <svg className="group" fill="none" height="24" viewBox="0 0 15 15" width="24">
              <path
                className="fill-primary-400 transition group-hover:fill-primary-500"
