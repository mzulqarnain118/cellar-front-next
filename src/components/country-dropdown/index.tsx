...
export const CountryDropdown = <Schema extends FieldValues>({
  className,
  size = 'md',
  ...props
  ...
  const [value, setValue] = useState<string | null>(props.defaultValue || 'United States')
  const data = [{ value: 'United States', label: 'United States' }]
